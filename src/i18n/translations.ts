...
export const translations = {
  de: {
    ...
    apartment: {
      ...
      cardCtaAvailable: 'Besichtigung anfragen',
      cardCtaUnavailable: 'Details ansehen',
      cardCtaTrust: 'Antwort in 24 Stunden',
      cardCtaTrustUnavailable: 'Nächste Verfügbarkeit prüfen',
  ...
  en: {
    ...
    apartment: {
      ...
      cardCtaAvailable: 'Request viewing',
      cardCtaUnavailable: 'View details',
      cardCtaTrust: 'Reply within 24 hours',
      cardCtaTrustUnavailable: 'Check next availability',
